...
class StatisticsFragment : Fragment() {
    ...
    private fun setupListeners() {
        ...
        view?.findViewById<com.google.android.material.card.MaterialCardView>(R.id.card_items_used)?.setOnClickListener {
            openFilteredItems("used")
        }

        view?.findViewById<com.google.android.material.card.MaterialCardView>(R.id.card_items_expired)?.setOnClickListener {
            openFilteredItems("expired")
        }
    }

    private fun openFilteredItems(filterStatus: String) {
        val intent = Intent(requireContext(), FilteredItemsActivity::class.java).apply {
